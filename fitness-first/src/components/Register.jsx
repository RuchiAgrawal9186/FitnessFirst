...
export const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(userRegister({ ...data, id: data.email })).then(() => {
      navigate("/login");
    });
  };
  ...
  return (
    <div className="mt-[12%]">
      <ToastContainer />
      <div className="w-full p-6 m-auto bg-zinc-700 mt-[7%] rounded-xl shadow-xl lg:max-w-xl">
        <form onSubmit={handleSubmit} className="w-full m-auto max-w-lg">
