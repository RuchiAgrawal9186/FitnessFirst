      ...
      <div className="">
        ...
        <div className="w-full p-6 m-auto bg-zinc-400 mt-[7%] rounded-xl shadow-xl lg:max-w-xl">
          ...
          <div className="flex mt-4 gap-x-2">
            <button
              type="button"
              className="flex items-center bg-orange-600 justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600"
            >
              <svg
            ...
            {/* <GoogleLogin onSuccess={responseMessage} onError={errorMessage} cookiePolicy="single_host_origin" clientId="1053018327165-t2oe92vahvq8s9of2n6tlmk52amtudph.apps.googleusercontent.com"
